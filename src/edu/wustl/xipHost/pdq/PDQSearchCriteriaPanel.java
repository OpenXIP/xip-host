 ...
 *
 */
public class PDQSearchCriteriaPanel extends JPanel {	
	...
	public PDQSearchCriteriaPanel(){		
	    ...
	    btnSearchPatientID.setForeground(Color.BLACK);
	...
	public static void main(String args[]){
		PDQSearchCriteriaPanel panel = new PDQSearchCriteriaPanel();
