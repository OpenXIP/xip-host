...
public class NCIARetrieve implements Runnable {
	String seriesInstanceUID;
	GridLocation gridLocation;
	File importLocation;
	NCIACoreServiceClient client;
	
	public NCIARetrieve(String seriesInstanceUID, GridLocation gridLocation, File importLocation){
	...
	NCIARetrieveListener listener;
    public void addNCIARetrieveListener(NCIARetrieveListener l) {        
        listener = l;          
    }
	void notifyDicomAvailable(){
		NCIARetrieveEvent event = new NCIARetrieveEvent(this);         		
