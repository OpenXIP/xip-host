...
public class StoreApplicationsTest {
	...
	public void setUp() throws Exception {
		...
		app1 = new Application("Application1", new String("./src-tests/edu/wustl/xipHost/application/test.bat"), "", "", "src-tests/edu/wustl/xipHost/application/test.png",
				"rendering", true, "files", 1, IterationTarget.SERIES);
		app2 = new Application("Application2", new String("./src-tests/edu/wustl/xipHost/application/test.bat"), "", "", "src-tests/edu/wustl/xipHost/application/test.png",
				"rendering", true, "files", 1, IterationTarget.SERIES);
	}
