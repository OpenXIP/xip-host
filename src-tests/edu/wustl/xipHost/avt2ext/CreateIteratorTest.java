...
public class CreateIteratorTest extends TestCase {
	...
	public void testCreateIterator_1A(){
		AVTQuery avtQuery = new AVTQuery(null, null, null, null, null);
		...
		assertTrue("", assertIterTargetPatient(iter));
	}
	...
	private boolean assertIterTargetPatient(Iterator<TargetElement> iter){
		int numberOfElements = 0;
