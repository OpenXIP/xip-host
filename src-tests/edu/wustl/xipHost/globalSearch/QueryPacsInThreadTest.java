 ...
 *
 */
public class QueryPacsInThreadTest extends TestCase {
	...
	protected void setUp() throws Exception {
		super.setUp();
		pacsLoc = new PacsLocation("127.0.0.1", 3002, "WORKSTATION2", "WS2");
		//pacsLoc = new PacsLocation("10.252.175.31", 2350, "BERLIN", "Steve Moore");
	...
	public void testQueryPacsLocationThread1A() {										              		
